...
@section('title', 'Редактировать ' . ($type === 'terms' ? 'Условия использования' : 'Политику конфиденциальности'))

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2>Редактировать {{ $type === 'terms' ? 'Условия использования' : 'Политику конфиденциальности' }}</h2>
    <a href="{{ route($viewRoute) }}" class="btn btn-secondary" target="_blank">Посмотреть страницу</a>
</div>
