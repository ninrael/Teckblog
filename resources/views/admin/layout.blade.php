        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                @if(request()->routeIs('admin.posts.*'))
                    <form action="{{ route('admin.posts.index') }}" method="GET" class="search-form me-3">
                        <input type="text" name="search" class="search-input" placeholder="Поиск статей..." value="{{ request('search') }}">
                ...
                @elseif(request()->routeIs('admin.users.*'))
                    <form action="{{ route('admin.users.index') }}" method="GET" class="search-form me-3">
                        <input type="text" name="search" class="search-input" placeholder="Поиск пользователей..." value="{{ request('search') }}">
                        <button type="submit" class="search-btn">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                            </svg>
                ...
                @elseif(request()->routeIs('admin.comments.*'))
                    <form action="{{ route('admin.comments.index') }}" method="GET" class="search-form me-3">
                        <input type="text" name="search" class="search-input" placeholder="Поиск комментариев..." value="{{ request('search') }}">
                        <button type="submit" class="search-btn">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                            </svg>
                ...
                @endif
                <a href="{{ route('home') }}" class="btn btn-outline-light btn-sm me-2" target="_blank">На сайт</a>
